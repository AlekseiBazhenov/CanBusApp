package ru.test.testjni.speedviews;
...
import ru.test.testjni.speedviews.components.Indicators.Indicator;
import ru.test.testjni.speedviews.components.Indicators.NoIndicator;
import ru.test.testjni.speedviews.components.note.Note;
import ru.test.testjni.speedviews.util.OnPrintTickLabel;
